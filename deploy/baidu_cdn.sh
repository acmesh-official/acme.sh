...
#
# Code generated by GitHub Copilot with Claude Sonnet 4.6
#
# API Doc:  https://cloud.baidu.com/doc/CDN/s/Zkna2r57w
#
# Credentials are shared with dnsapi/dns_baidu.sh:
...
baidu_cdn_deploy() {
  ...
  # Source dnsapi/dns_baidu.sh to reuse BCE authentication and credential helpers
  _dnsapi_baidu="$(_findHook "$_cdomain" "$_SUB_FOLDER_DNSAPI" dns_baidu)"
  # shellcheck source=/dev/null
  if ! . "$_dnsapi_baidu"; then
    _err "Error loading $_dnsapi_baidu. Please check your API file and try again."
    return 1
  fi
  ...
  *) _cert_name="c${_cert_name}" ;;
  ...
  _H1="Authorization: $_BAIDU_BCE_AUTH_RESULT"
  _H2="x-bce-date: $_ts"
...
# dns_baidu.sh's _baidu_bce_auth omits query strings (BCD API has none);
